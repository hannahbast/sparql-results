export type RenderConfig = TableRenderConfig | LinePlotRenderConfig | PetrimapsRenderConfig;
...
export declare function isURIValue(value: BindingValue): value is URIValue;
export declare function isLiteralValue(value: BindingValue): value is LiteralValue;
export declare function isBlankNodeValue(value: BindingValue): value is BlankNodeValue;
export declare function isTripleValue(value: BindingValue): value is TripleValue;
