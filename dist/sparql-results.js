import { bisector as e, extent as t, max as n, min as r } from "d3-array";
import { axisBottom as i, axisLeft as a } from "d3-axis";
import { scaleLinear as o, scalePoint as s, scaleTime as c } from "d3-scale";
import { create as l, pointer as u, select as d } from "d3-selection";
import { curveMonotoneX as f, line as p } from "d3-shape";
//#region src/lineplot/lineplot.css?inline
var m = ".lineplot{--lp-text:#1f2933;--lp-muted:#7b8794;--lp-grid:#e4e7eb;--lp-axis:#cbd2d9;--lp-surface:#fff;--lp-surface-border:#e4e7eb;width:100%;height:100%;color:var(--lp-text);font-family:system-ui,sans-serif;position:relative}@media (prefers-color-scheme:dark){.lineplot{--lp-text:#e4e7eb;--lp-muted:#9aa5b1;--lp-grid:#2b2f36;--lp-axis:#3e444c;--lp-surface:#1f2227;--lp-surface-border:#3e444c}}.lineplot svg{width:100%;height:auto;display:block;overflow:visible}.lineplot .lp-grid line{stroke:var(--lp-grid);stroke-width:1px;shape-rendering:crispedges}.lineplot .lp-grid .domain,.lineplot .lp-grid path{display:none}.lineplot .lp-axis .domain,.lineplot .lp-axis .tick line{stroke:var(--lp-axis)}.lineplot .lp-axis .tick text{fill:var(--lp-muted);font-size:11px}.lineplot .lp-axis-label{fill:var(--lp-muted);font-size:12px;font-weight:500}.lineplot .lp-line{fill:none;stroke-width:2px;stroke-linejoin:round;stroke-linecap:round;transition:opacity .15s}.lineplot .lp-dot{transition:r .12s,opacity .15s}.lineplot.lp-has-hover .lp-line{opacity:.35}.lineplot.lp-has-hover .lp-line.lp-active{opacity:1}.lineplot .lp-crosshair{stroke:var(--lp-muted);stroke-width:1px;stroke-dasharray:4 3;pointer-events:none}.lineplot .lp-focus-dot{stroke:var(--lp-surface);stroke-width:2px;pointer-events:none}.lineplot .lp-legend{flex-wrap:wrap;justify-content:center;gap:.25rem 1rem;margin-top:.5rem;display:flex}.lineplot .lp-legend-item{color:var(--lp-muted);cursor:pointer;-webkit-user-select:none;user-select:none;align-items:center;gap:.4rem;font-size:12px;transition:color .15s,opacity .15s;display:inline-flex}.lineplot .lp-legend-item:hover{color:var(--lp-text)}.lineplot .lp-legend-item.lp-disabled{opacity:.4}.lineplot .lp-legend-swatch{border-radius:3px;flex-shrink:0;width:12px;height:12px}.lineplot .lp-tooltip{pointer-events:none;z-index:10;background:var(--lp-surface);border:1px solid var(--lp-surface-border);min-width:120px;color:var(--lp-text);opacity:0;border-radius:8px;padding:.5rem .625rem;font-size:12px;transition:opacity .12s,transform .12s;position:absolute;top:0;left:0;transform:translateY(2px);box-shadow:0 4px 16px #0000001f}.lineplot .lp-tooltip.lp-visible{opacity:1;transform:translateY(0)}.lineplot .lp-tooltip-x{margin-bottom:.35rem;font-weight:600}.lineplot .lp-tooltip-row{align-items:center;gap:.4rem;line-height:1.5;display:flex}.lineplot .lp-tooltip-swatch{border-radius:2px;flex-shrink:0;width:9px;height:9px}.lineplot .lp-tooltip-name{color:var(--lp-muted);margin-right:auto}.lineplot .lp-tooltip-value{font-variant-numeric:tabular-nums;font-weight:600}.lineplot .lp-empty{text-align:center;color:var(--lp-muted);padding:2rem;font-size:13px}", h = new CSSStyleSheet();
h.replaceSync(m);
var g = {
	sheet: h,
	render: b,
...
function v(e) {
	let t = e.shadowRoot.getElementById("result");
	t && (_.get(t)?.disconnect(), _.delete(t));
}
var y = [
	"#3b82f6",
	"#ef4444",
...
function b(e, t, n) {
	let r = e.shadowRoot.getElementById("result");
	r.innerHTML = "";
	let i = document.createElement("div");
	i.className = "lineplot", r.appendChild(i);
	let a = n.y.filter((e) => t.head.vars.includes(e));
	if (!t.head.vars.includes(n.x) || a.length === 0) {
		oe(i, "Line plot config does not match the result columns.");
		return;
	}
	let o = t.results.bindings, s = o.map((e) => C(e[n.x])), c = o.length > 0 && s.every((e) => e !== null), l = c ? [] : o.map((e) => te(e[n.x])), u = !c && o.length > 0 && l.every((e) => e !== null), d = c ? "numeric" : u ? "date" : "category", f = o.map((e, t) => ({
		x: d === "numeric" ? s[t] : d === "date" ? l[t] : t,
		xLabel: d === "date" ? ne(l[t]) : re(e[n.x]) ?? String(t)
	})), p = d === "category" ? f.map((e, t) => t) : f.map((e, t) => t).sort((e, t) => f[e].x - f[t].x), m = a.map((e, n) => {
		let r = p.map((n) => {
			let r = C(t.results.bindings[n][e]);
			return r === null ? null : {
				x: f[n].x,
				xLabel: f[n].xLabel,
				y: r
	...
	if (m.every((e) => e.points.length === 0)) {
		oe(i, "No numeric values to plot for the selected columns.");
		return;
	}
	let h = /* @__PURE__ */ new Set(), g = 0, v = 0, b = new ResizeObserver((e) => {
		let t = Math.round(e[0].contentRect.width), r = Math.round(e[0].contentRect.height);
		t && (t !== g || r !== v) && (g = t, v = r, x(i, m, f, p, n, d, h));
	});
	_.get(r)?.disconnect(), _.set(r, b), b.observe(i);
}
function x(m, h, g, _, v, y, b) {
	let x = y !== "category";
	m.replaceChildren();
	let C, w = document.createElement("div");
	w.className = "lp-legend";
	let te = () => {
		C.style("display", (e) => b.has(e.name) ? "none" : null), w.querySelectorAll(".lp-legend-item").forEach((e) => {
			e.classList.toggle("lp-disabled", b.has(e.dataset.series));
		});
	};
	for (let e of h) {
		let t = document.createElement("div");
		t.className = "lp-legend-item", t.dataset.series = e.name, t.innerHTML = `<span class="lp-legend-swatch" style="background:${e.color}"></span><span>${ae(e.name)}</span>`, t.addEventListener("click", () => {
			b.has(e.name) ? b.delete(e.name) : b.size < h.length - 1 && b.add(e.name), te();
		}), t.addEventListener("pointerenter", () => {
			m.classList.add("lp-has-hover"), C.select(".lp-line").classed("lp-active", (t) => t.name === e.name);
		}), t.addEventListener("pointerleave", () => {
			m.classList.remove("lp-has-hover");
		}), w.appendChild(t);
	}
	m.appendChild(w);
	let ne = m.clientWidth || 640, re = w.offsetHeight + parseFloat(getComputedStyle(w).marginTop || "0"), oe = m.clientHeight - re, se = oe > 120 ? oe : Math.min(Math.round(ne * .5), Math.max(240, Math.round(window.innerHeight * .75))), T = {
		top: 16,
		right: 24,
		bottom: 44,
		left: 56
	}, E = ne - T.left - T.right, D = se - T.top - T.bottom, O = t(_.map((e) => g[e].x)), ce = y === "date" ? c().domain(O).range([0, E]).nice() : o().domain(O).nice().range([0, E]), le = s().domain(_.map((e) => g[e].x)).range([0, E]).padding(.5), ue = x ? ce : le, de = h.flatMap((e) => e.points.map((e) => e.y)), fe = Math.min(0, r(de) ?? 0), pe = n(de) ?? 1, me = o().domain([fe, pe]).nice().range([D, 0]), k = (e) => (ue(e) ?? 0) + T.left, he = (e) => me(e) + T.top, A = l("svg").attr("viewBox", `0 0 ${ne} ${se}`).attr("preserveAspectRatio", "xMidYMid meet").attr("role", "img");
	A.append("g").attr("class", "lp-grid").attr("transform", `translate(${T.left},${T.top})`).call(a(me).tickSize(-E).tickFormat(() => ""));
	let ge = x ? i(ce).ticks(6) : i(le).tickFormat((e) => g[e].xLabel).tickValues(S(_.map((e) => g[e].x), E));
	A.append("g").attr("class", "lp-axis").attr("transform", `translate(${T.left},${D + T.top})`).call(ge), A.append("g").attr("class", "lp-axis").attr("transform", `translate(${T.left},${T.top})`).call(a(me).ticks(6)), A.append("text").attr("class", "lp-axis-label").attr("text-anchor", "middle").attr("x", T.left + E / 2).attr("y", se - 6).text(v.xLabel ?? v.x), A.append("text").attr("class", "lp-axis-label").attr("text-anchor", "middle").attr("transform", `translate(14,${T.top + D / 2}) rotate(-90)`).text(v.yLabel ?? (h.length === 1 ? h[0].name : "value"));
	let _e = p().x((e) => k(e.x)).y((e) => he(e.y)).curve(f);
	C = A.selectAll("g.lp-series").data(h).join("g").attr("class", "lp-series").attr("data-series", (e) => e.name), C.append("path").attr("class", "lp-line").attr("stroke", (e) => e.color).attr("d", (e) => _e(e.points)), C.selectAll("circle").data((e) => e.points.map((t) => ({
		...t,
		color: e.color
	}))).join("circle").attr("class", "lp-dot").attr("cx", (e) => k(e.x)).attr("cy", (e) => he(e.y)).attr("r", h.flatMap((e) => e.points).length > 80 ? 0 : 3).attr("fill", (e) => e.color);
	let ve = A.append("line").attr("class", "lp-crosshair").attr("y1", T.top).attr("y2", T.top + D).style("display", "none"), ye = A.append("g").style("display", "none"), j = document.createElement("div");
	j.className = "lp-tooltip", m.appendChild(j);
	let be = _.map((e) => g[e]).sort((e, t) => e.x - t.x), xe = e((e) => e.x).center;
	A.append("rect").attr("x", T.left).attr("y", T.top).attr("width", E).attr("height", D).attr("fill", "transparent").on("pointermove", (e) => {
		let [t] = u(e), n = be[xe(be, x ? +ce.invert(t - T.left) : ee(le, t - T.left))];
		if (!n) return;
		ve.attr("x1", k(n.x)).attr("x2", k(n.x)).style("display", null);
		let r = [];
		if (ye.style("display", null).selectAll("circle").data(h.filter((e) => !b.has(e.name))).join("circle").attr("class", "lp-focus-dot").attr("r", 5).attr("fill", (e) => e.color).each(function(e) {
			let t = e.points.find((e) => e.x === n.x);
			t ? (d(this).style("display", null).attr("cx", k(t.x)).attr("cy", he(t.y)), r.push({
				name: e.name,
				color: e.color,
				y: t.y
			})) : d(this).style("display", "none");
		}), r.length === 0) {
			j.classList.remove("lp-visible");
			return;
		}
		j.innerHTML = `<div class="lp-tooltip-x">${ae(n.xLabel)}</div>` + r.map((e) => `<div class="lp-tooltip-row"><span class="lp-tooltip-swatch" style="background:${e.color}"></span><span class="lp-tooltip-name">${ae(e.name)}</span><span class="lp-tooltip-value">${ie(e.y)}</span></div>`).join(""), j.classList.add("lp-visible");
		let i = k(n.x), a = j.offsetWidth, o = i + 14 + a > ne ? i - 14 - a : i + 14;
		j.style.left = `${Math.max(0, o)}px`, j.style.top = `${T.top + 8}px`;
	}).on("pointerleave", () => {
		ve.style("display", "none"), ye.style("display", "none"), j.classList.remove("lp-visible");
	}), m.insertBefore(A.node(), w);
}
function S(e, t) {
	let n = Math.max(2, Math.floor(t / 60));
	if (e.length <= n) return e;
	let r = Math.ceil(e.length / n);
	return e.filter((e, t) => t % r === 0);
}
function ee(e, t) {
	let n = e.domain(), r = n[0], i = Infinity;
	for (let a of n) {
		let n = Math.abs((e(a) ?? 0) - t);
		n < i && (i = n, r = a);
	}
	return r;
}
function C(e) {
	if (e == null || e.type === "uri" || e.type === "bnode" || e.type === "triple") return null;
	let t = Number(e.value);
	return Number.isFinite(t) ? t : null;
}
var w = /#(date|dateTime|gYear|gYearMonth)$/;
function te(e) {
	if (e == null || e.type !== "literal" || !e.datatype || !w.test(e.datatype)) return null;
	let t = Date.parse(e.value);
	return Number.isFinite(t) ? t : null;
}
function ne(e) {
	let t = new Date(e).toISOString();
	return t.endsWith("T00:00:00.000Z") ? t.slice(0, 10) : t.slice(0, 16) + "Z";
}
function re(e) {
	return e == null || e.type === "triple" ? null : e.value;
}
function ie(e) {
...
function oe(e, t) {
	...
	n.className = "lp-empty", n.textContent = t, e.appendChild(n);
}
//#endregion
...
//#endregion
//#region src/table/table.css?inline
var T = ".table-wrapper{overflow-x:auto}.table-wrapper.paginated{max-height:70vh;overflow-y:auto}.table-wrapper.paginated th{background-color:var(--sr-surface);position:sticky;top:0}.table-sentinel{height:1px}table{table-layout:auto;border-collapse:collapse;width:100%}td,th{text-align:left;padding:8px}tr{border-bottom:1px solid var(--sr-row-border)}tr:first-child{border-bottom-width:2px}tr:nth-child(2n){background-color:var(--sr-surface-alt)}td span{text-overflow:ellipsis;white-space:nowrap;overflow:hidden}td span:hover{color:var(--sr-accent);cursor:pointer}td span:active{color:var(--sr-accent-active)}td img{object-fit:cover;width:3cm}", E = new CSSStyleSheet();
E.replaceSync(T);
var D = {
	sheet: E,
	render: ce,
...
function ce(e, t, n) {
	O.get(e)?.observer?.disconnect();
	let r = e.shadowRoot.getElementById("result");
	r.innerHTML = "";
	let i = document.createElement("div");
	i.classList.add("table-wrapper"), n?.paginated && i.classList.add("paginated");
	let a = document.createElement("table");
	i.appendChild(a);
	let o = document.createElement("tr"), s = document.createElement("th");
	s.textContent = "#", o.appendChild(s);
	for (let e of t.head.vars) {
		let t = document.createElement("th");
		t.style.setProperty("text-align", "left"), t.textContent = e, o.appendChild(t);
	}
	a.appendChild(o);
	let c = {
		table: a,
	...
	if (O.set(e, c), de(e, c, t.results.bindings), r.appendChild(i), n?.paginated) {
		let t = document.createElement("div");
		t.className = "table-sentinel", i.appendChild(t);
		let n = new IntersectionObserver(([r]) => {
			r.isIntersecting && (n.unobserve(t), e.dispatchEvent(new CustomEvent("load-more", {
				bubbles: !0,
				composed: !0,
				detail: { offset: c.index - 1 }
			})));
		}, {
			root: i,
			rootMargin: "200px"
		});
		n.observe(t), c.sentinel = t, c.observer = n;
	}
}
function le(e, t) {
	let n = O.get(e);
	if (n) {
		if (t.length === 0) {
			n.observer?.disconnect(), n.observer = void 0;
			return;
		}
		de(e, n, t), n.observer && n.sentinel && n.observer.observe(n.sentinel);
	}
}
function ue(e) {
	let t = O.get(e);
	t && (t.observer?.disconnect(), O.delete(e));
}
function de(e, t, n) {
	let r = document.createDocumentFragment();
	for (let i of n) {
		let n = document.createElement("tr");
		n.classList = "dark:even:bg-[#1F1F26] not-dark:odd:bg-neutral-50 border-b border-b-gray-300 dark:border-b-gray-600";
		let a = document.createElement("td");
		a.textContent = `${t.index}`, a.className = "p-2 text-neutral-400", n.appendChild(a);
		for (let r of t.vars) {
			let t = fe(e, i[r]);
			n.appendChild(t);
		}
		r.appendChild(n), t.index++;
	}
	t.table.appendChild(r);
}
function fe(e, t) {
	if (t != null) switch (t.type) {
		case "uri": return k(e, t);
		case "literal": return me(e, t);
		case "bnode": return pe(t);
	}
	return document.createElement("td");
}
function pe(e) {
	let t = document.createElement("td"), n = document.createElement("span");
	return n.textContent = `_:${e.value}`, he(n, e.value), t.appendChild(n), t;
}
function me(e, t) {
	let n = document.createElement("td"), r = document.createElement("span");
	if (he(r, t.value), n.appendChild(r), t.datatype === "http://www.w3.org/2001/XMLSchema#decimal" && ge(t.value) ? r.textContent = parseFloat(t.value).toLocaleString("en-US") : r.textContent = t.value.length > 200 ? t.value.substring(0, 200) + "..." : t.value, r.title = n.textContent, t["xml:lang"]) {
		let n = document.createElement("span");
		n.textContent = ` @${t["xml:lang"]}`, n.className = "lang-tag text-gray-500 dark:text-gray-400 text-sm", e.settings.langAnnotations || n.style.setProperty("display", "none"), r.appendChild(n);
	}
	if (t.datatype) {
		let n = document.createElement("span");
		n.textContent = ` (${A(t.datatype)})`, n.className = "type-tag text-gray-500 dark:text-gray-400 text-sm", e.settings.typeAnnotations || n.style.setProperty("display", "none"), r.appendChild(n);
	}
	return n;
}
function k(e, t) {
	let n = document.createElement("td");
	if (n.title = t.value, e.settings.loadImages && ye(t.value)) {
		let e = document.createElement("img");
		e.src = t.value, e.alt = t.value, n.appendChild(e);
	} else {
		let r = document.createElement("a");
		if (r.href = t.value, r.title = t.value, r.className = "text-blue-600 dark:text-blue-400 hover:underline", r.target = "_blank", r.rel = "noopener noreferrer", t.curie) r.textContent = t.curie;
		else {
			let n = _e(t.value), i = document.createElement("span");
			i.className = "iri-short", i.textContent = n, e.settings.shortenIris || i.style.setProperty("display", "none");
			let a = document.createElement("span");
			a.className = "iri-full", a.textContent = t.value, e.settings.shortenIris && a.style.setProperty("display", "none"), r.appendChild(i), r.appendChild(a);
		}
		n.appendChild(r);
	}
	return n;
...
function he(e, t) {
	e.onclick = () => {
		navigator.clipboard.writeText(t), document.dispatchEvent(new CustomEvent("toast", { detail: {
			type: "success",
...
function A(e) {
	if (e.startsWith("http://www.w3.org/2001/XMLSchema#")) return "xsd:" + e.slice(33);
	let t = e.match(/[#/]([^#/]+)$/);
	return t ? t[1] : e;
}
function ge(e) {
	return !isNaN(Number(e)) && !isNaN(parseFloat(e));
}
function _e(e) {
	try {
		let t = new URL(e);
		if (t.hash && t.hash.length > 1) return t.hash.slice(1);
		let n = t.pathname.split("/").filter((e) => e.length > 0);
		return n.length > 0 ? n[n.length - 1] : t.hostname;
	} catch {
		return e;
	}
}
...
function ye(e) {
	try {
		let { pathname: t } = new URL(e), n = t.split(".").pop()?.toLowerCase();
		return n !== void 0 && ve.includes(n);
	} catch {
		return !1;
	}
}
...
var j = ":host{--sr-font:system-ui, sans-serif;--sr-text:#1f2933;--sr-surface:#fff;--sr-surface-alt:#eee;--sr-border:#888;--sr-row-border:#ccc;--sr-accent:#60a5fa;--sr-accent-active:#1e40af;--sr-radius:8px;--sr-padding:1rem;padding:var(--sr-padding);border:1px solid var(--sr-border);border-radius:var(--sr-radius);font-family:var(--sr-font);color:var(--sr-text);display:block}@media (prefers-color-scheme:dark){:host{--sr-text:#e4e7eb;--sr-surface:#1f2227;--sr-surface-alt:#2b2f36;--sr-border:#3e444c;--sr-row-border:#3e444c}}#result{height:100%}", be = Symbol.for("yaml.alias"), xe = Symbol.for("yaml.document"), M = Symbol.for("yaml.map"), Se = Symbol.for("yaml.pair"), N = Symbol.for("yaml.scalar"), Ce = Symbol.for("yaml.seq"), P = Symbol.for("yaml.node.type"), we = (e) => !!e && typeof e == "object" && e[P] === be, Te = (e) => !!e && typeof e == "object" && e[P] === xe, Ee = (e) => !!e && typeof e == "object" && e[P] === M, F = (e) => !!e && typeof e == "object" && e[P] === Se, I = (e) => !!e && typeof e == "object" && e[P] === N, De = (e) => !!e && typeof e == "object" && e[P] === Ce;
function L(e) {
	if (e && typeof e == "object") switch (e[P]) {
		case M:
		case Ce: return !0;
	}
	return !1;
...
var Oe = (e) => (I(e) || L(e)) && !!e.anchor, z = Symbol("break visit"), ke = Symbol("skip children"), B = Symbol("remove node");
function Ae(e, t) {
	let n = Pe(t);
	Te(e) ? je(null, e.contents, n, Object.freeze([e])) === B && (e.contents = null) : je(null, e, n, Object.freeze([]));
}
Ae.BREAK = z, Ae.SKIP = ke, Ae.REMOVE = B;
function je(e, t, n, r) {
	let i = Fe(e, t, n, r);
	if (R(i) || F(i)) return Ie(e, r, i), je(e, i, n, r);
	if (typeof i != "symbol") {
		if (L(t)) {
			r = Object.freeze(r.concat(t));
			for (let e = 0; e < t.items.length; ++e) {
				let i = je(e, t.items[e], n, r);
				if (typeof i == "number") e = i - 1;
				else if (i === z) return z;
				else i === B && (t.items.splice(e, 1), --e);
			}
		} else if (F(t)) {
			r = Object.freeze(r.concat(t));
			let e = je("key", t.key, n, r);
			if (e === z) return z;
			e === B && (t.key = null);
			let i = je("value", t.value, n, r);
			if (i === z) return z;
			i === B && (t.value = null);
		}
	}
...
async function Me(e, t) {
	let n = Pe(t);
	Te(e) ? await Ne(null, e.contents, n, Object.freeze([e])) === B && (e.contents = null) : await Ne(null, e, n, Object.freeze([]));
}
Me.BREAK = z, Me.SKIP = ke, Me.REMOVE = B;
async function Ne(e, t, n, r) {
	let i = await Fe(e, t, n, r);
	if (R(i) || F(i)) return Ie(e, r, i), Ne(e, i, n, r);
	if (typeof i != "symbol") {
		if (L(t)) {
			r = Object.freeze(r.concat(t));
			for (let e = 0; e < t.items.length; ++e) {
...
var Le = {
	...
	"{": "%7B",
	"}": "%7D"
}, Re = (e) => e.replace(/[!,[\]{}]/g, (e) => Le[e]), ze = class e {
	constructor(t, n) {
	...
	tagString(e) {
		for (let [t, n] of Object.entries(this.tags)) if (e.startsWith(n)) return t + Re(e.substring(n.length));
		return e[0] === "!" ? e : `!<${e}>`;
	}
	toString(e) {
		let t = this.yaml.explicit ? [`%YAML ${this.yaml.version || "1.2"}`] : [], n = Object.entries(this.tags), r;
		if (e && n.length > 0 && R(e.contents)) {
			let t = {};
			Ae(e.contents, (e, n) => {
				R(n) && n.tag && (t[n.tag] = !0);
			}), r = Object.keys(t);
...
function Ue(e, t) {
	...
	return {
		...
		setAnchors: () => {
			for (let e of n) {
				let t = r.get(e);
				if (typeof t == "object" && t.anchor && (I(t.node) || L(t.node))) t.node.anchor = t.anchor;
				else {
...
var Ge = class {
	...
	constructor(e) {
		super(be), this.source = e, Object.defineProperty(this, "tag", { set() {
	...
	resolve(e, t) {
		...
		let n;
		t?.aliasResolveCache ? n = t.aliasResolveCache : (n = [], Ae(e, { Node: (e, t) => {
			(we(t) || Oe(t)) && n.push(t);
	...
	toJSON(e, t) {
		...
		let o = n.get(a);
		/* istanbul ignore if */
		if (o ||= (V(a, null, t), n.get(a)), o?.res === void 0) throw ReferenceError("This should not happen: Alias anchor was not resolved?");
		if (i >= 0 && (o.count += 1, o.aliasCount === 0 && (o.aliasCount = qe(r, a, n)), o.count * o.aliasCount > i)) throw ReferenceError("Excessive alias count indicates a resource exhaustion attack");
		return o.res;
	}
	toString(e, t, n) {
		let r = `*${this.source}`;
...
function qe(e, t, n) {
	if (we(t)) {
		...
		let r = qe(e, t.key, n), i = qe(e, t.value, n);
		return Math.max(r, i);
	}
	return 1;
}
...
var Je = (e) => !e || typeof e != "function" && typeof e != "object", H = class extends Ge {
	constructor(e) {
...
function Ze(e, t, n) {
	if (Te(e) && (e = e.contents), R(e)) return e;
	if (F(e)) {
		let t = n.schema[M].createNode?.(n.schema, null, n);
	...
	if (r && e && typeof e == "object") {
		if (c = s.get(e), c) return c.anchor ??= i(e), new Ke(c.anchor);
		c = {
			anchor: null,
			node: null
		}, s.set(e, c);
	}
	t?.startsWith("!!") && (t = Ye + t.slice(2));
	let l = Xe(e, t, o.tags);
	if (!l) {
		...
		l = e instanceof Map ? o[M] : Symbol.iterator in Object(e) ? o[Ce] : o[M];
	}
	a && (a(l), delete n.onTagObj);
	let u = l?.createNode ? l.createNode(n.schema, e, n) : typeof l?.nodeClass?.from == "function" ? l.nodeClass.from(n.schema, e, n) : new H(e);
...
var $e = (e) => e == null || typeof e == "object" && !!e[Symbol.iterator]().next().done, et = class extends Ge {
	constructor(e, t) {
	...
	clone(e) {
		...
		return e && (t.schema = e), t.items = t.items.map((t) => R(t) || F(t) ? t.clone(e) : t), this.range && (t.range = this.range.slice()), t;
	}
	addIn(e, t) {
		if ($e(e)) this.add(t);
		else {
			...
			if (L(i)) i.addIn(r, t);
			else if (i === void 0 && this.schema) this.set(n, Qe(this.schema, r, t));
	...
	deleteIn(e) {
		...
		let r = this.get(t, !0);
		if (L(r)) return r.deleteIn(n);
		throw Error(`Expected YAML collection at ${t}. Remaining path: ${n}`);
	}
	getIn(e, t) {
		let [n, ...r] = e, i = this.get(n, !0);
		return r.length === 0 ? !t && I(i) ? i.value : i : L(i) ? i.getIn(r, t) : void 0;
	}
	hasAllNullValues(e) {
	...
	setIn(e, t) {
		...
		if (r.length === 0) this.set(n, t);
			...
			let e = this.get(n, !0);
			if (L(e)) e.setIn(r, t);
			else if (e === void 0 && this.schema) this.set(n, Qe(this.schema, r, t));
			else throw Error(`Expected YAML collection at ${n}. Remaining path: ${r}`);
		}
	}
}, tt = (e) => e.replace(/^(?!$)(?: $)?/gm, "#");
...
var W = (e, t, n) => e.endsWith("\n") ? U(n, t) : n.includes("\n") ? "\n" + U(n, t) : (e.endsWith(" ") ? "" : " ") + n, nt = "flow", rt = "block", it = "quoted";
function at(e, t, n = "flow", { indentAtStart: r, lineWidth: i = 80, minContentWidth: a = 20, onFold: o, onOverflow: s } = {}) {
	if (!i || i < 0) return e;
	i < a && (a = 0);
	...
	n === "block" && (h = ot(e, h, t.length), h !== -1 && (d = h + c));
	for (let r; r = e[h += 1];) {
		if (n === "quoted" && r === "\\") {
			switch (g = h, e[h + 1]) {
				case "x":
		...
		if (r === "\n") n === "block" && (h = ot(e, h, t.length)), d = h + t.length + c, f = void 0;
		else {
			if (r === " " && p && p !== " " && p !== "\n" && p !== "	") {
				let t = e[h + 1];
				t && t !== " " && t !== "\n" && t !== "	" && (f = h);
...
function ut(e, t) {
	...
	let { implicitKey: r } = t, i = t.options.doubleQuotedMinMultiLineLength, a = t.indent || (ct(e) ? "  " : ""), o = "", s = 0;
	...
	return o = s ? o + n.slice(s) : n, r ? o : at(o, a, it, st(t, !1));
}
function dt(e, t) {
	if (t.options.singleQuote === !1 || t.implicitKey && e.includes("\n") || /[ \t]\n|\n[ \t]/.test(e)) return ut(e, t);
	let n = t.indent || (ct(e) ? "  " : ""), r = "'" + e.replace(/'/g, "''").replace(/\n+/g, `$&\n${n}`) + "'";
	return t.implicitKey ? r : at(r, n, nt, st(t, !1));
}
function ft(e, t) {
...
function mt({ comment: e, type: t, value: n }, r, i, a) {
	let { blockQuote: o, commentString: s, lineWidth: c } = r.options;
	if (!o || /\n[\t ]+$/.test(n)) return ft(n, r);
	let l = r.indent || (r.forceBlockIndent || ct(n) ? "  " : ""), u = o === "literal" ? !0 : o === "folded" || t === H.BLOCK_FOLDED ? !1 : t === H.BLOCK_LITERAL ? !0 : !lt(n, c, l.length);
	if (!n) return u ? "|\n" : ">\n";
	let d, f;
...
function ht(e, t, n, r) {
	...
	if (s && a.includes("\n") || u && /[[\]{},]/.test(a)) return ft(a, t);
	if (/^[\n\t ,[\]{}#&*!|>'"%@`]|^[?-]$|^[?-][ \t]|[\n:][ \t]|[ \t]\n|[\n\t ]#|[\n\t :]$/.test(a)) return s || u || !a.includes("\n") ? ft(a, t) : mt(e, t, n, r);
	if (!s && !u && i !== H.PLAIN && a.includes("\n")) return mt(e, t, n, r);
	if (ct(a)) {
		if (c === "") return t.forceBlockIndent = !0, mt(e, t, n, r);
		if (s && c === l) return ft(a, t);
	}
	let d = a.replace(/\n+/g, `$&\n${c}`);
	if (o) {
		let e = (e) => e.default && e.tag !== "tag:yaml.org,2002:str" && e.test?.test(d), { compat: n, tags: r } = t.doc.schema;
		if (r.some(e) || n?.some(e)) return ft(a, t);
	}
	return s ? d : at(d, c, nt, st(t, !1));
}
function gt(e, t, n, r) {
	...
	let c = (e) => {
		switch (e) {
			case H.BLOCK_FOLDED:
			case H.BLOCK_LITERAL: return i || a ? ft(o.value, t) : mt(o, t, n, r);
			case H.QUOTE_DOUBLE: return ut(o.value, t);
			case H.QUOTE_SINGLE: return dt(o.value, t);
			case H.PLAIN: return ht(o, t, n, r);
			default: return null;
		}
	}, l = c(s);
	if (l === null) {
...
function yt(e, t, { anchors: n, doc: r }) {
	if (!r.directives) return "";
	let i = [], a = (I(e) || L(e)) && e.anchor;
...
function bt(e, t, n, r) {
	...
	let i, a = R(e) ? e : t.doc.createNode(e, { onTagObj: (e) => i = e });
	i ??= vt(t.doc.schema.tags, a);
	let o = yt(a, i, t);
	o.length > 0 && (t.indentAtStart = (t.indentAtStart ?? 0) + o.length + 1);
	let s = typeof i.stringify == "function" ? i.stringify(a, t, n, r) : I(a) ? gt(a, t, n, r) : a.toString(t, n, r);
	return o ? I(a) || s[0] === "{" || s[0] === "[" ? `${o} ${s}` : `${o}\n${t.indent}${s}` : s;
}
//#endregion
//#region node_modules/yaml/browser/dist/stringify/stringifyPair.js
function xt({ key: e, value: t }, n, r, i) {
	let { allNullValues: a, doc: o, indent: s, indentStep: c, options: { commentString: l, indentSeq: u, simpleKeys: d } } = n, f = R(e) && e.comment || null;
	if (d) {
		if (f) throw Error("With simple keys, key nodes cannot have comments");
		if (L(e) || !R(e) && typeof e == "object") throw Error("With simple keys, collection cannot be used as a key value");
	}
	let p = !d && (!e || f && t == null && !n.inFlow || L(e) || (I(e) ? e.type === H.BLOCK_FOLDED || e.type === H.BLOCK_LITERAL : typeof e == "object"));
	n = Object.assign({}, n, {
		allNullValues: !1,
		implicitKey: !p && (d || !a),
		indent: s + c
	});
	let m = !1, h = !1, g = bt(e, n, () => m = !0, () => h = !0);
	...
	} else if (a && !d || t == null && p) return g = `? ${g}`, f && !m ? g += W(g, n.indent, l(f)) : h && i && i(), g;
	m && (f = null), p ? (f && (g += W(g, n.indent, l(f))), g = `? ${g}\n${s}:`) : (g = `${g}:`, f && (g += W(g, n.indent, l(f))));
	let _, v, y;
	R(t) ? (_ = !!t.spaceBefore, v = t.commentBefore, y = t.comment) : (_ = !1, v = null, y = null, t && typeof t == "object" && (t = o.createNode(t))), n.implicitKey = !1, !p && !f && I(t) && (n.indentAtStart = g.length + 1), h = !1, !u && c.length >= 2 && !n.inFlow && !p && De(t) && !t.flow && !t.tag && !t.anchor && (n.indent = n.indent.substring(2));
	let b = !1, x = bt(t, n, () => b = !0, () => h = !0), S = " ";
	if (f || _ || v) {
		if (S = _ ? "\n" : "", v) {
			let e = l(v);
			S += `\n${U(e, n.indent)}`;
	...
	return g += S + x, n.inFlow ? b && r && r() : y && !b ? g += W(g, n.indent, l(y)) : h && i && i(), g;
}
//#endregion
...
var Ct = "<<", G = {
	...
	test: /^<<$/,
	resolve: () => Object.assign(new H(Symbol(Ct)), { addToJSMap: Tt }),
	stringify: () => Ct
}, wt = (e, t) => (G.identify(t) || I(t) && (!t.type || t.type === H.PLAIN) && G.identify(t.value)) && e?.doc.schema.tags.some((e) => e.tag === G.tag && e.default);
function Tt(e, t, n) {
	let r = Dt(e, n);
	if (De(r)) for (let n of r.items) Et(e, t, n);
	else if (Array.isArray(r)) for (let n of r) Et(e, t, n);
	else Et(e, t, r);
}
function Et(e, t, n) {
	let r = Dt(e, n);
...
function Ot(e, t, { key: n, value: r }) {
	if (R(n) && n.addToJSMap) n.addToJSMap(e, t, r);
...
function kt(e, t, n) {
	...
	if (R(e) && n?.doc) {
		...
		if (!n.mapKeyWarned) {
			...
			e.length > 40 && (e = e.substring(0, 36) + "...\""), St(n.doc.options.logLevel, `Keys with collection values will be stringified due to JS Object restrictions: ${e}. Set mapAsMap: true to use object keys.`), n.mapKeyWarned = !0;
		}
		return r;
	}
...
function At(e, t, n) {
	return new K(Ze(e, void 0, n), Ze(t, void 0, n));
}
var K = class e {
	constructor(e, t = null) {
		Object.defineProperty(this, P, { value: Se }), this.key = e, this.value = t;
	}
	clone(t) {
		let { key: n, value: r } = this;
		return R(n) && (n = n.clone(t)), R(r) && (r = r.clone(t)), new e(n, r);
	}
	toJSON(e, t) {
		return Ot(t, t?.mapAsMap ? /* @__PURE__ */ new Map() : {}, this);
	}
	toString(e, t, n) {
		return e?.doc ? xt(this, e, t, n) : JSON.stringify(this);
	}
};
//#endregion
...
function Mt({ comment: e, items: t }, n, { blockItemPrefix: r, flowChars: i, itemIndent: a, onChompKeep: o, onComment: s }) {
	...
	for (let e = 0; e < t.length; ++e) {
		let i = t[e], o = null;
		if (R(i)) !d && i.spaceBefore && f.push(""), Pt(n, f, i.commentBefore, d), i.comment && (o = i.comment);
		else if (F(i)) {
			let e = R(i.key) ? i.key : null;
			e && (!d && e.spaceBefore && f.push(""), Pt(n, f, e.commentBefore, d));
		}
		d = !1;
		let s = bt(i, u, () => o = null, () => d = !0);
		o && (s += W(s, a, l(o))), d && o && (d = !1), f.push(r + s);
	}
	let p;
...
function Nt({ items: e }, t, { flowChars: n, itemIndent: r }) {
	...
	for (let n = 0; n < e.length; ++n) {
		let i = e[n], a = null;
		if (R(i)) i.spaceBefore && d.push(""), Pt(t, d, i.commentBefore, !1), i.comment && (a = i.comment);
		else if (F(i)) {
			let e = R(i.key) ? i.key : null;
			e && (e.spaceBefore && d.push(""), Pt(t, d, e.commentBefore, !1), e.comment && (l = !0));
			let n = R(i.value) ? i.value : null;
			n ? (n.comment && (a = n.comment), n.commentBefore && (l = !0)) : i.value == null && e?.comment && (a = e.comment);
		}
		a && (l = !0);
		let o = bt(i, c, () => a = null);
		l ||= d.length > u || o.includes("\n"), n < e.length - 1 ? o += "," : t.options.trailingComma && (t.options.lineWidth > 0 && (l ||= d.reduce((e, t) => e + t.length + 2, 2) + (o.length + 2) > t.options.lineWidth), l && (o += ",")), a && (o += W(o, r, s(a))), d.push(o), u = d.length;
	}
	let { start: f, end: p } = n;
...
function q(e, t) {
	let n = I(t) ? t.value : t;
	for (let r of e) if (F(r) && (r.key === t || r.key === n || I(r.key) && r.key.value === n)) return r;
}
var J = class extends et {
	...
	add(e, t) {
		let n;
		n = F(e) ? e : !e || typeof e != "object" || !("key" in e) ? new K(e, e?.value) : new K(e.key, e.value);
		let r = q(this.items, n.key), i = this.schema?.sortMapEntries;
		if (r) {
			if (!t) throw Error(`Key ${n.key} already set`);
			I(r.value) && Je(n.value) ? r.value.value = n.value : r.value = n.value;
		} else if (i) {
	...
	delete(e) {
		let t = q(this.items, e);
		return t ? this.items.splice(this.items.indexOf(t), 1).length > 0 : !1;
	}
	get(e, t) {
		let n = q(this.items, e)?.value;
	...
	toString(e, t, n) {
		...
		return !e.allNullValues && this.hasAllNullValues(!1) && (e = Object.assign({}, e, { allNullValues: !0 })), jt(this, e, {
			blockItemPrefix: "",
			flowChars: {
				start: "{",
				end: "}"
	...
	set(e, t) {
		...
		let r = this.items[n];
		I(r) && Je(t) ? r.value = t : this.items[n] = t;
	}
	toJSON(e, t) {
		let n = [];
...
var Lt = {
	...
	resolve: (e) => e,
	stringify(e, t, n, r) {
		return t = Object.assign({ actualString: !0 }, t), gt(e, t, n, r);
	}
}, zt = {
	identify: (e) => e == null,
	...
	test: /^(?:~|[Nn]ull|NULL)?$/,
	resolve: () => new H(null),
	stringify: ({ source: e }, t) => typeof e == "string" && zt.test.test(e) ? e : t.options.nullStr
}, Bt = {
	...
	stringify({ source: e, value: t }, n) {
		return e && Bt.test.test(e) && t === (e[0] === "t" || e[0] === "T") ? e : t ? n.options.trueStr : n.options.falseStr;
	}
};
//#endregion
//#region node_modules/yaml/browser/dist/stringify/stringifyNumber.js
function X({ format: e, minFractionDigits: t, tag: n, value: r }) {
...
var Vt = {
	...
	stringify(e) {
		let t = Number(e.value);
		return isFinite(t) ? t.toExponential() : X(e);
	}
}, Ut = {
	identify: (e) => typeof e == "number",
	default: !0,
	...
	test: /^[-+]?(?:\.[0-9]+|[0-9]+\.[0-9]*)$/,
	resolve(e) {
		let t = new H(parseFloat(e)), n = e.indexOf(".");
		return n !== -1 && e[e.length - 1] === "0" && (t.minFractionDigits = e.length - n - 1), t;
	},
	stringify: X
}, Wt = (e) => typeof e == "bigint" || Number.isInteger(e), Gt = (e, t, n, { intAsBigInt: r }) => r ? BigInt(e) : parseInt(e.substring(t), n);
function Kt(e, t, n) {
	let { value: r } = e;
	return Wt(r) && r >= 0 ? n + r.toString(t) : X(e);
}
var qt = {
	identify: (e) => Wt(e) && e >= 0,
	default: !0,
	...
	format: "OCT",
	test: /^0o[0-7]+$/,
	resolve: (e, t, n) => Gt(e, 2, 8, n),
	stringify: (e) => Kt(e, 8, "0o")
}, Jt = {
	identify: Wt,
	default: !0,
	tag: "tag:yaml.org,2002:int",
	test: /^[-+]?[0-9]+$/,
	resolve: (e, t, n) => Gt(e, 0, 10, n),
	stringify: X
}, Yt = {
	identify: (e) => Wt(e) && e >= 0,
	default: !0,
	...
	format: "HEX",
	test: /^0x[0-9a-fA-F]+$/,
	resolve: (e, t, n) => Gt(e, 2, 16, n),
	stringify: (e) => Kt(e, 16, "0x")
}, Xt = [
	Ft,
	Lt,
	Rt,
...
var Qt = ({ value: e }) => JSON.stringify(e), $t = [
	{
		identify: (e) => typeof e == "string",
		default: !0,
		tag: "tag:yaml.org,2002:str",
	...
	},
	{
		...
		stringify: ({ value: e }) => Zt(e) ? e.toString() : JSON.stringify(e)
	},
	{
		identify: (e) => typeof e == "number",
		default: !0,
...
function nn(e, t) {
	if (De(e)) for (let n = 0; n < e.items.length; ++n) {
		let r = e.items[n];
		if (!F(r)) {
			if (Ee(r)) {
				r.items.length > 1 && t("Each pair must have its own sequence indicator");
				let e = r.items[0] || new K(new H(null));
...
var an = {
	...
	resolve: nn,
	createNode: rn
}, on = class e extends Y {
	constructor() {
		super(), this.add = J.prototype.add.bind(this), this.delete = J.prototype.delete.bind(this), this.get = J.prototype.get.bind(this), this.has = J.prototype.has.bind(this), this.set = J.prototype.set.bind(this), this.tag = e.tag;
	}
	toJSON(e, t) {
		...
		for (let e of this.items) {
			let r, i;
			if (F(e) ? (r = V(e.key, "", t), i = V(e.value, r, t)) : r = V(e, "", t), n.has(r)) throw Error("Ordered maps must not include duplicate keys");
			n.set(r, i);
		}
		return n;
	}
...
var sn = {
	...
	resolve(e, t) {
		let n = nn(e, t), r = [];
		for (let { key: e } of n.items) I(e) && (r.includes(e.value) ? t(`Ordered maps must not include duplicate keys: ${e.value}`) : r.push(e.value));
		return Object.assign(new on(), n);
	},
	createNode: (e, t, n) => on.from(e, t, n)
};
//#endregion
//#region node_modules/yaml/browser/dist/schema/yaml-1.1/bool.js
function cn({ value: e, source: t }, n) {
	return t && (e ? ln : un).test.test(t) ? t : e ? n.options.trueStr : n.options.falseStr;
}
var ln = {
	identify: (e) => e === !0,
	default: !0,
	...
	test: /^[-+]?(?:[0-9][0-9_]*)?\.[0-9_]*$/,
	resolve(e) {
		let t = new H(parseFloat(e.replace(/_/g, ""))), n = e.indexOf(".");
		if (n !== -1) {
	...
	stringify: X
}, mn = (e) => typeof e == "bigint" || Number.isInteger(e);
function hn(e, t, n, { intAsBigInt: r }) {
	let i = e[0];
...
var _n = {
	...
	format: "BIN",
	test: /^[-+]?0b[0-1_]+$/,
	resolve: (e, t, n) => hn(e, 2, 2, n),
	stringify: (e) => gn(e, 2, "0b")
}, vn = {
	identify: mn,
	default: !0,
	tag: "tag:yaml.org,2002:int",
	format: "OCT",
	test: /^[-+]?0[0-7_]+$/,
	resolve: (e, t, n) => hn(e, 1, 8, n),
	stringify: (e) => gn(e, 8, "0")
}, yn = {
	identify: mn,
	default: !0,
	tag: "tag:yaml.org,2002:int",
	test: /^[-+]?[0-9][0-9_]*$/,
	resolve: (e, t, n) => hn(e, 0, 10, n),
	stringify: X
}, bn = {
	identify: mn,
	default: !0,
	...
	format: "HEX",
	test: /^[-+]?0x[0-9a-fA-F_]+$/,
	resolve: (e, t, n) => hn(e, 2, 16, n),
	stringify: (e) => gn(e, 16, "0x")
}, xn = class e extends J {
	constructor(t) {
		super(t), this.tag = e.tag;
	}
	add(e) {
		let t;
		t = F(e) ? e : e && typeof e == "object" && "key" in e && "value" in e && e.value === null ? new K(e.key, null) : new K(e, null), q(this.items, t.key) || this.items.push(t);
	}
	get(e, t) {
		let n = q(this.items, e);
		return !t && F(n) ? I(n.key) ? n.key.value : n.key : n;
	}
	set(e, t) {
	...
	static from(e, t, n) {
		let { replacer: r } = n, i = new this(e);
		if (t && Symbol.iterator in Object(t)) for (let e of t) typeof r == "function" && (e = r.call(t, e, e)), i.items.push(At(e, null, n));
		return i;
	}
};
xn.tag = "tag:yaml.org,2002:set";
var Sn = {
	collection: "map",
	...
	createNode: (e, t, n) => xn.from(e, t, n),
	resolve(e, t) {
		if (Ee(e)) {
			if (e.hasAllNullValues(!0)) return Object.assign(new xn(), e);
...
function wn(e) {
	...
	else if (isNaN(t) || !isFinite(t)) return X(e);
	let r = "";
	t < 0 && (r = "-", t *= n(-1));
	let i = n(60), a = [t % i];
...
var Tn = {
	...
	resolve: (e, t, { intAsBigInt: n }) => Cn(e, n),
	stringify: wn
}, En = {
	identify: (e) => typeof e == "number",
	default: !0,
	...
	"tag:yaml.org,2002:binary": tn,
	"tag:yaml.org,2002:merge": G,
	"tag:yaml.org,2002:omap": sn,
	"tag:yaml.org,2002:pairs": an,
	"tag:yaml.org,2002:set": Sn,
	"tag:yaml.org,2002:timestamp": Dn
};
function Mn(e, t, n) {
	let r = kn.get(t);
	if (r && !e) return n && !r.includes(G) ? r.concat(G) : r.slice();
	let i = r;
	if (!i) if (Array.isArray(e)) i = [];
	else {
		let e = Array.from(kn.keys()).filter((e) => e !== "yaml11").map((e) => JSON.stringify(e)).join(", ");
	...
	return n && (i = i.concat(G)), i.reduce((e, t) => {
		let n = typeof t == "string" ? An[t] : t;
		if (!n) {
			let e = JSON.stringify(t), n = Object.keys(An).map((e) => JSON.stringify(e)).join(", ");
...
var Nn = (e, t) => e.key < t.key ? -1 : +(e.key > t.key), Pn = class e {
	constructor({ compat: e, customTags: t, merge: n, resolveKnownTags: r, schema: i, sortMapEntries: a, toStringDefaults: o }) {
		this.compat = Array.isArray(e) ? Mn(e, "compat") : e ? Mn(null, e) : null, this.name = typeof i == "string" && i || "core", this.knownTags = r ? jn : {}, this.tags = Mn(t, this.name, n), this.toStringOptions = o ?? null, Object.defineProperty(this, M, { value: Ft }), Object.defineProperty(this, N, { value: Rt }), Object.defineProperty(this, Ce, { value: Lt }), this.sortMapEntries = typeof a == "function" ? a : a === !0 ? Nn : null;
	}
	clone() {
...
function Fn(e, t) {
	...
	r && n.push("---");
	let i = _t(e, t), { commentString: a } = i.options;
	if (e.commentBefore) {
	...
	if (e.contents) {
		...
		let t = s ? void 0 : () => o = !0, c = bt(e.contents, i, () => s = null, t);
		s && (c += W(c, "", a(s))), (c[0] === "|" || c[0] === ">") && n[n.length - 1] === "---" ? n[n.length - 1] = `--- ${c}` : n.push(c);
	} else n.push(bt(e.contents, i));
	if (e.directives?.docEnd) if (e.comment) {
		let t = a(e.comment);
		t.includes("\n") ? (n.push("..."), n.push(U(t, ""))) : n.push(`... ${t}`);
	} else n.push("...");
	else {
		let t = e.comment;
		t && o && (t = t.replace(/^\n+/, "")), t && ((!o || s) && n[n.length - 1] !== "" && n.push(""), n.push(U(a(t), "")));
	}
	return n.join("\n") + "\n";
}
//#endregion
...
var In = class e {
	constructor(e, t, n) {
		this.commentBefore = null, this.comment = null, this.errors = [], this.warnings = [], Object.defineProperty(this, P, { value: xe });
		let r = null;
		...
		this.options = i;
		let { version: a } = i;
		n?._directives ? (this.directives = n._directives.atDocument(), this.directives.yaml.explicit && (a = this.directives.yaml.version)) : this.directives = new ze({ version: a }), this.setSchema(a, n), this.contents = e === void 0 ? null : this.createNode(e, r, n);
	}
	clone() {
		let t = Object.create(e.prototype, { [P]: { value: xe } });
		return t.commentBefore = this.commentBefore, t.comment = this.comment, t.errors = this.errors.slice(), t.warnings = this.warnings.slice(), t.options = Object.assign({}, this.options), this.directives && (t.directives = this.directives.clone()), t.schema = this.schema.clone(), t.contents = R(this.contents) ? this.contents.clone(t.schema) : this.contents, this.range && (t.range = this.range.slice()), t;
	}
	add(e) {
		Ln(this.contents) && this.contents.add(e);
	}
	addIn(e, t) {
		Ln(this.contents) && this.contents.addIn(e, t);
	}
	createAlias(e, t) {
		if (!e.anchor) {
			let n = Ve(this);
	...
	createNode(e, t, n) {
		...
		return o && L(m) && (m.flow = !0), d(), m;
	}
	createPair(e, t, n = {}) {
		return new K(this.createNode(e, null, n), this.createNode(t, null, n));
	}
	delete(e) {
		return Ln(this.contents) ? this.contents.delete(e) : !1;
	}
	deleteIn(e) {
		return $e(e) ? this.contents == null ? !1 : (this.contents = null, !0) : Ln(this.contents) ? this.contents.deleteIn(e) : !1;
	}
	get(e, t) {
		return L(this.contents) ? this.contents.get(e, t) : void 0;
	}
	getIn(e, t) {
		return $e(e) ? !t && I(this.contents) ? this.contents.value : this.contents : L(this.contents) ? this.contents.getIn(e, t) : void 0;
	}
	has(e) {
		return L(this.contents) ? this.contents.has(e) : !1;
	}
	hasIn(e) {
		return $e(e) ? this.contents !== void 0 : L(this.contents) ? this.contents.hasIn(e) : !1;
	}
	set(e, t) {
		this.contents == null ? this.contents = Qe(this.schema, [e], t) : Ln(this.contents) && this.contents.set(e, t);
	}
	setIn(e, t) {
		$e(e) ? this.contents = t : this.contents == null ? this.contents = Qe(this.schema, Array.from(e), t) : Ln(this.contents) && this.contents.setIn(e, t);
	}
	setSchema(e, t = {}) {
		...
		switch (e) {
			case "1.1":
				this.directives ? this.directives.yaml.version = "1.1" : this.directives = new ze({ version: "1.1" }), n = {
					resolveKnownTags: !1,
					schema: "yaml-1.1"
				};
				break;
			case "1.2":
			case "next":
				this.directives ? this.directives.yaml.version = e : this.directives = new ze({ version: e }), n = {
					resolveKnownTags: !0,
					schema: "core"
				};
				break;
		...
		else if (n) this.schema = new Pn(Object.assign(n, t));
...
function Hn(e, { flow: t, indicator: n, next: r, offset: i, onError: a, parentIndent: o, startOnNewline: s }) {
...
function Wn(e, t, n) {
	if (t?.type === "flow-collection") {
		let r = t.end[0];
		r.indent === e && (r.source === "]" || r.source === "}") && Un(t) && n(r, "BAD_INDENT", "Flow end indicator should be more indented than parent", !0);
	}
}
//#endregion
...
function Gn(e, t, n) {
	...
	if (r === !1) return !1;
	let i = typeof r == "function" ? r : (e, t) => e === t || I(e) && I(t) && e.value === t.value;
	return t.some((e) => i(e.key, n));
}
//#endregion
//#region node_modules/yaml/browser/dist/compose/resolve-block-map.js
var Kn = "All mapping items must start at the same column";
function qn({ composeNode: e, composeEmptyNode: t }, n, r, i, a) {
	let o = new (a?.nodeClass ?? J)(n.schema);
	n.atRoot &&= !1;
	let s = r.offset, c = null;
	for (let a of r.items) {
		let { start: l, key: u, sep: d, value: f } = a, p = Hn(l, {
		...
		if (m) {
			if (u && (u.type === "block-seq" ? i(s, "BLOCK_AS_IMPLICIT_KEY", "A block sequence may not be used as an implicit map key") : "indent" in u && u.indent !== r.indent && i(s, "BAD_INDENT", Kn)), !p.anchor && !p.tag && !d) {
				c = p.end, p.comment && (o.comment ? o.comment += "\n" + p.comment : o.comment = p.comment);
				continue;
			}
			(p.newlineAfterProp || Un(u)) && i(u ?? l[l.length - 1], "MULTILINE_IMPLICIT_KEY", "Implicit keys need to be on a single line");
		} else p.found?.indent !== r.indent && i(s, "BAD_INDENT", Kn);
		n.atKey = !0;
		let h = p.end, g = u ? e(n, u, p, i) : t(n, h, l, null, p, i);
		n.schema.compat && Wn(r.indent, u, i), n.atKey = !1, Gn(n, o.items, g) && i(h, "DUPLICATE_KEY", "Map keys must be unique");
		let _ = Hn(d ?? [], {
...
function Jn({ composeNode: e, composeEmptyNode: t }, n, r, i, a) {
	let o = new (a?.nodeClass ?? Y)(n.schema);
...
var Xn = "Block collections are not allowed within flow collections", Zn = (e) => e && (e.type === "block-map" || e.type === "block-seq");
function Qn({ composeNode: e, composeEmptyNode: t }, n, r, i, a) {
	let o = r.start.source === "{", s = o ? "flow map" : "flow sequence", c = new (a?.nodeClass ?? (o ? J : Y))(n.schema);
	c.flow = !0;
	let l = n.atRoot;
	l && (n.atRoot = !1), n.atKey &&= !1;
	let u = r.offset + r.start.source.length;
	for (let a = 0; a < r.items.length; ++a) {
		let l = r.items[a], { start: d, key: f, sep: p, value: m } = l, h = Hn(d, {
			flow: s,
			indicator: "explicit-key-ind",
			next: f ?? p?.[0],
			offset: u,
		...
		if (!h.found) {
			...
			!o && n.options.strict && Un(f) && i(f, "MULTILINE_IMPLICIT_KEY", "Implicit keys of flow sequence pairs need to be on a single line");
		}
		...
		if (!o && !p && !h.found) {
			...
			c.items.push(r), u = r.range[2], Zn(m) && i(r.range, "BLOCK_IN_FLOW", Xn);
		} else {
			n.atKey = !0;
			let a = h.end, g = f ? e(n, f, h, i) : t(n, a, d, null, h, i);
			Zn(f) && i(g.range, "BLOCK_IN_FLOW", Xn), n.atKey = !1;
			let _ = Hn(p ?? [], {
				flow: s,
				indicator: "map-value-ind",
				next: m,
			...
			v ? Zn(m) && i(v.range, "BLOCK_IN_FLOW", Xn) : _.comment && (g.comment ? g.comment += "\n" + _.comment : g.comment = _.comment);
			let y = new K(g, v);
			if (n.options.keepSourceTokens && (y.srcToken = l), o) {
				let e = c;
				Gn(n, e.items, g) && i(a, "DUPLICATE_KEY", "Map keys must be unique"), e.items.push(y);
			} else {
				let e = new J(n.schema);
	...
	if (p.length > 0) {
		let e = Yn(p, m, n.options.strict, i);
...
function $n(e, t, n, r, i, a) {
	let o = n.type === "block-map" ? qn(e, t, n, r, a) : n.type === "block-seq" ? Jn(e, t, n, r, a) : Qn(e, t, n, r, a), s = o.constructor;
...
function er(e, t, n, r, i) {
	...
	if (!a || !o || o === "!" || o === J.tagName && s === "map" || o === Y.tagName && s === "seq") return $n(e, t, n, i, o);
	...
	if (!c) {
		...
		else return r ? i(a, "BAD_COLLECTION_TYPE", `${r.tag} used for ${s} collection, but expects ${r.collection ?? "scalar"}`, !0) : i(a, "TAG_RESOLVE_FAILED", `Unresolved tag: ${o}`, !0), $n(e, t, n, i, o);
	}
	let l = $n(e, t, n, i, o, c), u = c.resolve?.(l, (e) => i(a, "TAG_RESOLVE_FAILED", e), t.options) ?? l, d = R(u) ? u : new H(u);
...
function tr(e, t, n) {
	let r = t.offset, i = nr(t, e.options.strict, n);
	if (!i) return {
		value: "",
		type: null,
		comment: "",
	...
	let a = i.mode === ">" ? H.BLOCK_FOLDED : H.BLOCK_LITERAL, o = t.source ? rr(t.source) : [], s = o.length;
	...
	for (let e = u; e < s; ++e) {
		...
		a === H.BLOCK_LITERAL ? (d += f + t.slice(c) + r, f = "\n") : t.length > c || r[0] === "	" ? (f === " " ? f = "\n" : !p && f === "\n" && (f = "\n\n"), d += f + t.slice(c) + r, f = "\n", p = !0) : r === "" ? f === "\n" ? d += "\n" : f = "\n" : (d += f + r, f = " ", p = !1);
	}
	switch (i.chomp) {
		case "-": break;
		case "+":
...
function nr({ offset: e, props: t }, n, r) {
...
function ir(e, t, n) {
	...
	switch (i) {
		case "scalar":
			...
			break;
		case "single-quoted-scalar":
			s = H.QUOTE_SINGLE, c = or(a, l);
			break;
		case "double-quoted-scalar":
			s = H.QUOTE_DOUBLE, c = cr(a, l);
			break;
		/* istanbul ignore next should not happen */
...
function ar(e, t) {
	...
	return n && t(0, "BAD_SCALAR_START", `Plain value cannot start with ${n}`), sr(e);
}
function or(e, t) {
	return (e[e.length - 1] !== "'" || e.length === 1) && t(e.length, "MISSING_CHAR", "Missing closing 'quote"), sr(e.slice(1, -1)).replace(/''/g, "'");
}
function sr(e) {
	let t, n;
	try {
...
function fr(e, t, n, r) {
	let { value: i, type: a, comment: o, range: s } = t.type === "block-scalar" ? tr(e, t, r) : ir(t, e.options.strict, r), c = n ? e.directives.tagName(n.source, (e) => r(n, "TAG_RESOLVE_FAILED", e)) : null, l;
	l = e.options.stringKeys && e.atKey ? e.schema[N] : c ? pr(e.schema, i, c, n, r) : t.type === "scalar" ? mr(e, i, t, r) : e.schema[N];
	let u;
	try {
		...
		r(n ?? t, "TAG_RESOLVE_FAILED", a), u = new H(i);
	}
...
function pr(e, t, n, r, i) {
	...
	return o && !o.collection ? (e.tags.push(Object.assign({}, o, {
		default: !1,
		test: void 0
	})), o) : (i(r, "TAG_RESOLVE_FAILED", `Unresolved tag: ${n}`, n !== "tag:yaml.org,2002:str"), e[N]);
}
function mr({ atKey: e, directives: t, schema: n }, r, i, a) {
	let o = n.tags.find((t) => (t.default === !0 || e && t.default === "key") && t.test?.test(r)) || n[N];
	if (n.compat) {
		let e = n.compat.find((e) => e.default && e.test?.test(r)) ?? n[N];
...
function _r(e, t, n, r) {
	...
	switch (t.type) {
		case "alias":
			l = yr(e, t, r), (s || c) && r(t, "ALIAS_PROPS", "An alias node must not specify any properties");
			break;
		case "scalar":
		case "single-quoted-scalar":
		case "double-quoted-scalar":
		case "block-scalar":
			l = fr(e, t, c, r), s && (l.anchor = s.source.substring(1));
			break;
		case "block-map":
		case "block-seq":
		case "flow-collection":
			try {
				l = er(gr, e, t, n, r), s && (l.anchor = s.source.substring(1));
			} catch (e) {
	...
	return l ??= vr(e, t.offset, void 0, null, n, r), s && l.anchor === "" && r(s, "BAD_ALIAS", "Anchor cannot be an empty string"), i && e.options.stringKeys && (!I(l) || typeof l.value != "string" || l.tag && l.tag !== "tag:yaml.org,2002:str") && r(c ?? t, "NON_STRING_KEY", "With stringKeys, all keys must be strings"), a && (l.spaceBefore = !0), o && (t.type === "scalar" && t.source === "" ? l.comment = o : l.commentBefore = o), e.options.keepSourceTokens && u && (l.srcToken = t), l;
}
function vr(e, t, n, r, { spaceBefore: i, comment: a, anchor: o, tag: s, end: c }, l) {
	let u = fr(e, {
		type: "scalar",
		offset: hr(t, n, r),
		indent: -1,
...
function yr({ options: e }, { offset: t, source: n, end: r }, i) {
	let a = new Ke(n.substring(1));
	...
	let o = t + n.length, s = Yn(r, o, e.strict, i);
	return a.range = [
		t,
		o,
		s.offset
...
function br(e, t, { offset: n, start: r, value: i, end: a }, o) {
	let s = new In(void 0, Object.assign({ _directives: t }, e)), c = {
		atKey: !1,
		atRoot: !0,
	...
	l.found && (s.directives.docStart = !0, i && (i.type === "block-map" || i.type === "block-seq") && !l.hasNewline && o(l.end, "MISSING_CHAR", "Block collection cannot start on same line with directives-end marker")), s.contents = i ? _r(c, i, l, o) : vr(c, l.end, r, null, l, o);
	let u = s.contents.range[2], d = Yn(a, u, !1, o);
...
var Cr = class {
	constructor(e = {}) {
		this.doc = null, this.atDirectives = !1, this.prelude = [], this.errors = [], this.warnings = [], this.onError = (e, t, n, r) => {
			let i = xr(e);
			r ? this.warnings.push(new Bn(i, t, n)) : this.errors.push(new zn(i, t, n));
		}, this.directives = new ze({ version: e.version || "1.2" }), this.options = e;
	}
	decorate(e, t) {
		let { comment: n, afterEmptyLine: r } = Sr(this.prelude);
		if (n) {
			let i = e.contents;
			if (t) e.comment = e.comment ? `${e.comment}\n${n}` : n;
			else if (r || e.directives.docStart || !i) e.commentBefore = n;
			else if (L(i) && !i.flow && i.items.length > 0) {
				let e = i.items[0];
				F(e) && (e = e.key);
	...
	streamInfo() {
		return {
			comment: Sr(this.prelude).comment,
	...
	*next(e) {
		switch (e.type) {
			case "directive":
				...
				break;
			case "document": {
				let t = br(this.options, this.directives, e, this.onError);
			...
			case "newline":
				...
				break;
			case "error": {
				let t = e.source ? `${e.message}: ${JSON.stringify(e.source)}` : e.message, n = new zn(xr(e), "UNEXPECTED_TOKEN", t);
				this.atDirectives || !this.doc ? this.errors.push(n) : this.doc.errors.push(n);
				break;
			}
			case "doc-end": {
				if (!this.doc) {
					this.errors.push(new zn(xr(e), "UNEXPECTED_TOKEN", "Unexpected doc-end without preceding document"));
					break;
				}
				this.doc.directives.docEnd = !0;
				let t = Yn(e.end, e.offset + e.source.length, this.doc.options.strict, this.onError);
			...
			default: this.errors.push(new zn(xr(e), "UNEXPECTED_TOKEN", `Unsupported token ${e.type}`));
		}
	}
	*end(e = !1, t = -1) {
		if (this.doc) this.decorate(this.doc, !0), yield this.doc, this.doc = null;
		else if (e) {
			let e = new In(void 0, Object.assign({ _directives: this.directives }, this.options));
...
}, wr = Symbol("break visit"), Tr = Symbol("skip children"), Er = Symbol("remove item");
function Dr(e, t) {
	"type" in e && e.type === "document" && (e = {
		start: e.start,
		value: e.value
	}), Or(Object.freeze([]), e, t);
}
Dr.BREAK = wr, Dr.SKIP = Tr, Dr.REMOVE = Er, Dr.itemAtPath = (e, t) => {
	let n = e;
	for (let [e, r] of t) {
		let t = n?.[e];
	...
	return n;
}, Dr.parentCollection = (e, t) => {
	let n = Dr.itemAtPath(e, t.slice(0, -1)), r = t[t.length - 1][0], i = n?.[r];
	...
	for (let i of ["key", "value"]) {
		...
		if (a && "items" in a) {
			for (let t = 0; t < a.items.length; ++t) {
				let r = Or(Object.freeze(e.concat([[i, t]])), a.items[t], n);
				if (typeof r == "number") t = r - 1;
				else if (r === wr) return wr;
...
var Ar = /* @__PURE__ */ new Set("0123456789ABCDEFabcdef"), jr = /* @__PURE__ */ new Set("0123456789ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz-#;/?:@&=+$_.!~*'()"), Mr = /* @__PURE__ */ new Set(",[]{}"), Nr = /* @__PURE__ */ new Set(" ,[]{}\n\r	"), Pr = (e) => !e || Nr.has(e), Fr = class {
	constructor() {
	...
	*parsePlainScalar() {
		...
		for (; r = this.buffer[++n];) if (r === ":") {
			...
			if (Z(r) || e && Mr.has(r)) break;
			t = n;
		} else if (Z(r)) {
			let i = this.buffer[n + 1];
			if (r === "\r" && (i === "\n" ? (n += 1, r = "\n", i = this.buffer[n + 1]) : t = n), i === "#" || e && Mr.has(i)) break;
			if (r === "\n") {
	...
	*pushTag() {
		if (this.charAt(1) === "<") {
			...
			for (; t;) if (jr.has(t)) t = this.buffer[++e];
			else if (t === "%" && Ar.has(this.buffer[e + 1]) && Ar.has(this.buffer[e + 2])) t = this.buffer[e += 3];
			else break;
...
function Hr(e) {
	if (e.start.type === "flow-seq-start") for (let t of e.items) t.sep && !t.value && !Q(t.start, "explicit-key-ind") && !Q(t.sep, "map-value-ind") && (t.key && (t.value = t.key), delete t.key, Rr(t.value) ? t.value.end ? Vr(t.value.end, t.sep) : t.value.end = t.sep : Vr(t.start, t.sep), delete t.sep);
}
var Ur = class {
	constructor(e) {
	...
	*pop(e) {
		...
		if (!t) yield {
			...
			let e = this.peek(1);
			switch (t.type === "block-scalar" ? t.indent = "indent" in e ? e.indent : 0 : t.type === "flow-collection" && e.type === "document" && (t.indent = 0), t.type === "flow-collection" && Hr(t), e.type) {
				case "document":
					e.value = t;
					break;
				case "block-scalar":
			...
			if ((e.type === "document" || e.type === "block-map" || e.type === "block-seq") && (t.type === "block-map" || t.type === "block-seq")) {
				...
				n && !n.sep && !n.value && n.start.length > 0 && Lr(n.start) === -1 && (t.indent === 0 || n.start.every((e) => e.type !== "comment" || e.indent < t.indent)) && (e.type === "document" ? e.end = n.start : e.items.push({ start: n.start }), t.items.splice(-1, 1));
			}
		}
	}
	*stream() {
	...
	*document(e) {
		...
		switch (this.type) {
			case "doc-start":
				Lr(e.start) === -1 ? e.start.push(this.sourceToken) : (yield* this.pop(), yield* this.step());
				return;
			case "anchor":
			case "tag":
			case "space":
			...
			case "comment":
				if (t.value) e.items.push({ start: [this.sourceToken] });
					...
					if (this.atIndentedComment(t.start, e.indent)) {
						...
						if (Array.isArray(n)) {
							Vr(n, t.start), n.push(this.sourceToken), e.items.pop();
							return;
						}
					}
		...
		if (this.indent >= e.indent) {
			...
			switch (this.type) {
				...
				case "map-value-ind":
					...
					else if (Rr(t.key) && !Q(t.sep, "newline")) {
						let e = Br(t.start), n = t.key, r = t.sep;
...
function Wr(e) {
	...
	return {
		lineCounter: e.lineCounter || t && new Ir() || null,
		prettyErrors: t
	};
}
function Gr(e, t = {}) {
	let { lineCounter: n, prettyErrors: r } = Wr(t), i = new Ur(n?.addNewLine), a = new Cr(t), o = null;
	for (let t of a.compose(i.parse(e), !0, e.length)) if (!o) o = t;
	else if (o.options.logLevel !== "silent") {
		o.errors.push(new zn(t.range.slice(0, 2), "MULTIPLE_DOCS", "Source contains multiple documents; please use YAML.parseAllDocuments()"));
		break;
	}
	return r && n && (o.errors.forEach(Vn(e, n)), o.warnings.forEach(Vn(e, n))), o;
}
function Kr(e, t, n) {
	let r;
	...
	let i = Gr(e, n);
	if (!i) return null;
	if (i.warnings.forEach((e) => St(i.options.logLevel, e)), i.errors.length > 0) {
...
function qr(e) {
	...
	try {
		...
		return $(`invalid YAML in config comment: ${e.message}`);
	}
	if (!Xr(n) || !("result-plot" in n)) return {
		ok: !0,
		config: { type: "table" }
	};
	let r = n["result-plot"];
	return Xr(r) ? Zr(r) : $("\"result-plot\" must be a mapping of config fields");
}
var Jr = /^\s*#\+ ?(.*)$/;
function Yr(e) {
	let t = [];
...
function Zr(e) {
	let t = e.type;
	if (t === void 0) return $("result-plot config is missing \"type\"");
	if (typeof t != "string") return $("\"type\" must be a string");
	switch (t) {
		case "lineplot": return $r(e);
		case "table": return ei(e);
		case "petrimaps": return ri(e);
		default: return $(`unknown plot type "${t}"`);
	}
}
function Qr(e, t, n) {
	for (let r of Object.keys(e)) if (!t.includes(r)) return `unknown field "${r}" in ${n} config`;
	return null;
}
function $r(e) {
	let t = Qr(e, [
	...
	if (t) return $(t);
	if (typeof e.x != "string" || e.x === "") return $("lineplot config requires \"x\" to be a variable name");
	let n;
	if (typeof e.y == "string" && e.y !== "") n = [e.y];
	else if (Array.isArray(e.y) && e.y.length > 0 && e.y.every((e) => typeof e == "string")) n = e.y;
	else return $("lineplot config requires \"y\" to list at least one variable");
	let r = {
		type: "lineplot",
		x: e.x,
		y: n
	};
	for (let t of ["xLabel", "yLabel"]) {
		let n = e[t];
		if (n !== void 0) {
			if (typeof n != "string") return $(`"${t}" must be a string`);
			r[t] = n;
		}
	}
	return {
...
function ei(e) {
	let t = Qr(e, ["type", "paginated"], "table");
	if (t) return $(t);
	let n = { type: "table" };
	if (e.paginated !== void 0) {
		if (typeof e.paginated != "boolean") return $("\"paginated\" must be true or false");
		n.paginated = e.paginated;
	}
	return {
		ok: !0,
		config: n
...
function ri(e) {
	let t = Qr(e, ["type", "layers"], "petrimaps");
	if (t) return $(t);
	if (!Array.isArray(e.layers) || e.layers.length === 0) return $("petrimaps config requires \"layers\" to list at least one layer");
	let n = [];
	for (let [t, r] of e.layers.entries()) {
		let e = ii(r);
		if (typeof e == "string") return $(`layer ${t + 1}: ${e}`);
		n.push(e);
	}
	return {
		ok: !0,
...
function ii(e) {
	if (!Xr(e)) return "must be a mapping of layer fields";
	let t = Qr(e, [
		"geomfield",
		"id",
		"name",
	...
	if (t) return t;
	if (typeof e.geomfield != "string" || e.geomfield === "") return "\"geomfield\" must be a variable name";
	let n = { geomfield: e.geomfield };
	for (let t of [
		"id",
		"name",
		"weightfield",
		...
		let r = e[t];
		if (r !== void 0) {
			if (typeof r != "string" || r === "") return `"${t}" must be a non-empty string`;
			n[t] = r;
		}
	}
	for (let t of ["rasterw", "rasterh"]) {
		let r = e[t];
		if (r !== void 0) {
			if (typeof r != "number" || !Number.isInteger(r) || r <= 0) return `"${t}" must be a positive integer`;
			n[t] = r;
		}
	}
	if (e.color !== void 0) {
		if (typeof e.color != "string" || !/^[0-9a-fA-F]{6}$/.test(e.color)) return "\"color\" must be a 6-digit hex string without \"#\" (quote it, e.g. \"3388ff\")";
		n.color = e.color;
	}
	if (e.colorscheme !== void 0) {
		if (typeof e.colorscheme != "string" || !ni.includes(e.colorscheme)) return `unknown colorscheme "${e.colorscheme}"`;
		n.colorscheme = e.colorscheme;
	}
	if (e.style !== void 0) {
		let t = ti.find((t) => t === e.style);
		if (t === void 0) return `unknown style "${e.style}"`;
		n.style = t;
	}
	if (e.pointsize !== void 0) {
		let t = e.pointsize;
		if (typeof t != "number" || !Number.isInteger(t) || t < 0 || t > 50) return "\"pointsize\" must be an integer between 0 and 50";
		n.pointsize = t;
	}
	return n;
}
//#endregion
//#region src/sparql-results.ts
	...
	render_results(e, t) {
		switch (t.type) {
			...
			case "lineplot":
				g.render(this, e, t);
				break;
			default: throw `Unknown config type ${t.type}`;
		}
	}
	clear() {
		D.clear(this), g.clear(this), this.render();
	}
	append_results(e) {
		D.appendRows(this, e);
	}
};
customElements.define("sparql-results", oi);
//#endregion
export { oi as SparqlResults, qr as extractConfig };
